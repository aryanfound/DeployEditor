...
const mockProjects: Project[] = [
  {
    ...
    files: [
        ...
        children: [
          {
            ...
            type: 'folder',
            children: [
              { id: 'f3', name: 'App.tsx', type: 'file', activeUsers: [{ id: '1', name: 'John Doe', avatar: 'https://images.unsplash.com/photo-1472099645785-5658abf4ff4e?w=32&h=32&fit=crop&crop=faces', status: 'online' }] },
      ...
      { id: 'f6', name: 'package.json', type: 'file', activeUsers: [{ id: '2', name: 'Jane Smith', avatar: 'https://images.unsplash.com/photo-1438761681033-6461ffad8d80?w=32&h=32&fit=crop&crop=faces', status: 'offline' }] }
    ]
  },
  {
    id: '2',
